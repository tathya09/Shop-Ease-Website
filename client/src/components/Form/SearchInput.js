...
const SearchInput = () => {
  ...
  const navigate=useNavigate()
    const handleSubmit=async(e)=>
    {
        ...
        try{
            ...
            setValues({...values,results:data});//fullfilling results array which we made
            navigate("/search");
        }
        catch(error)
        {
  ...
  />
  <button className="btn btn-outline-success" type="submit">Search your favourite Products</button>
</form>
